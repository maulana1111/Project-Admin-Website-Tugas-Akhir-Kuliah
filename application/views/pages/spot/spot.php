<h3 align="center">-- Foto Spot Menarik --</h3>
<div class="wrapper">
    <div class="contact-form">
        <?php echo form_open_multipart() ?>
            <div class="input-fields">
                ...
                <input type="file" class="form-control-file" name="image" onchange="loadFile()" id="file">
                <br>
    ...
    <table>
        ...
        <?php $i=1; foreach($data as $row) { ?>
            <tr>
                ...
                <td>
                    <img src="<?php echo base_url() ?>uploads/spot/<?php echo $row->foto ?>" data-toggle="modal" data-target="#myModal1<?php echo $i ?>">
                </td>
